...
public class Word_Database : MonoBehaviour 
{
	...
	public string[,] uiTextsLang = new string[14, 25]
	{
		...
		// FILL THE SPACES OF THE ARRAY (THE QUOTATION MARKS) WITH THE CORRESPONDING TRANSLATION
									...
									/* The \n is for do a newline */
		/* LANGUAGE BY DEFAULT: */ {"NIVEAU", "COMPLETER", "JOUER", "Resoudre le casse tête\n pour moi", "Montrer une lettre \naleatoire \nde la reponse", "piece", "OK", "NON", "", "Vous n’avez pas assez\nde pieces.", "Selectionner la categorie", "Total des mots resolus", "Pourcentage total", "", "Mots resolus", "Pourcentage resolu", "MENU", "Questions resolues:", "Vous avez besoin ", " mots resolus pour deverrouiller.", "Continuer", "Evaluez nous avec 5 etoiles et recevez ", " pieces", "Evaluez maintenant!", "Plus tard"},
		/* LANGUAGE # 1:  */ 	   {"NIVEAU", "COMPLETER", "JOUER", "Resoudre le casse tête\n pour moi", "Montrer une lettre \naleatoire \nde la reponse", "piece", "OK", "NON", "", "Vous n’avez pas assez\nde pieces.", "Selectionner la categorie", "Total des mots resolus", "Pourcentage total", "", "Mots resolus", "Pourcentage resolu", "MENU", "Questions resolues:", "Vous avez besoin ", " mots resolus pour deverrouiller.", "Continuer", "Evaluez nous avec 5 etoiles et recevez ", " pieces", "Evaluez maintenant!", "Plus tard"},
		/* LANGUAGE # 2:  */       {"LEVEL", "COMPLETED", "PLAY", "Solve puzzle for me", "Show one random\nletter of the answer", "coins", "OK", "NO", "", "You don't have\nenough coins.", "Category Selection", "Total solved words", "Total porcent", "", "Solved words", "Porcent solved", "MENU", "Solved questions:", "You need have ", " solved words to unlock.", "Continue", "Rate us 5 stars and get ", " coins", "Rate now!", "Later"},
		/* LANGUAGE # 3:  */       {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
		/* LANGUAGE # 4:  */       {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
		/* LANGUAGE # 5:  */       {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
		/* LANGUAGE # 6:  */       {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
