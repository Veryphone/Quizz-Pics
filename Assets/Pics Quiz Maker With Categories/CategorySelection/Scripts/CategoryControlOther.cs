...
public class CategoryControlOther : MonoBehaviour {
    ...
    void Start ()
    {
        ...
        GameObject.Find("CATEGORY_SELECTION").transform.FindChild("Canvas").transform.FindChild("TopBox").transform.FindChild("SolvedWords").transform.FindChild("TotalSolvedWords").GetComponent<Text>().text = totalSolvedWords + "/" + totalWords;
        GameObject.Find("CATEGORY_SELECTION").transform.FindChild("Canvas").transform.FindChild("TopBox").transform.FindChild("TotalPorcent").transform.FindChild("TotalPorcent").GetComponent<Text>().text = ((totalSolvedWords * 100) / totalWords).ToString()+"%";
